...
// Модификация для автоматической загрузки книги из папки 'books'
const params = new URLSearchParams(location.search)
const id = params.get('id')
if (id) {
    // Формируем путь к файлу по параметру id, например, если id = 1, то путь "books/book1.epub"
    const filePath = `books/book${id}.epub`
